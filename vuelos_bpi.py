# Vuelos con búsqueda con produnidad iterativa
from arbol import Nodo


def BFS_prof_iter(nodo, solucion):
            ...
            for nodo_hijo in nodo.get_hijos():
                if not nodo_hijo.get_datos() in visitados:
                    ...
                    sol = buscar_solucion_DFS_Rec(
                        nodo_hijo, solucion, visitados, limite=1)
                    if sol != None:
                        return sol
        return None
...
if __name__ == "__main__":
    ...
    nodo = BFS_prof_iter(nodo_inicial, solucion)
